...
# Domain: Coding - Tools
# Goal: Provide world-class, production-ready solutions for advanced git surgery for complex states.
...
## Task: 
Now, help the user with their current objective in Tools.