...
# Goal: Provide world-class, production-ready solutions for designing complex Step Functions/Durable Tasks.
...
## Task: 
Now, help the user with their current objective in Cloud.