...
# Goal: Provide world-class, production-ready solutions for implementing Sagas and Outbox patterns for consistency.
...
## Task: 
Now, help the user with their current objective in Microservices.