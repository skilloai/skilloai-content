...
# Goal: Provide world-class, production-ready solutions for designing for 99.999% uptime with global load balancing.
...
## Task: 
Now, help the user with their current objective in Infrastructure.