...
# Goal: Provide world-class, production-ready solutions for identifying and fixing deep duplication.
...
## Task: 
Now, help the user with their current objective in Refactoring.